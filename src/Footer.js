            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-5 w-full">
                ...
                <p className="mb-5 text-base text-body-color">
                  Count on Finactaxpro for all your business needs. From
                  accounting and taxation to setup, compliance, and more, we've
                  got you covered. Simplify your journey to success with
                  Finactaxpro
                </p>
              </div>
            </div>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color mb-3">
                  &copy;Finactaxpro services Bharam LLP
                </p>
                <p className="flex items-center text-sm font-medium text-dark ">
                  ...
                  <span>+91-9850524322/+91-9730649059</span>
                </p>
              </div>
            </div>
          </div>
