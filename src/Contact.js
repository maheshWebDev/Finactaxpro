            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color ">
                  We offer expert assistance with tax-related inquiries and
                  financial planning needs. Our team provides personalized
                  solutions to help you achieve financial success. Contact us
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    <h4 className="mb-1 blo text-xl font-bold text-dark ">
                      Corporate & Operational Office
                    </h4>
                    <p className="text-base text-body-color ">
                      Flat No-201, Second Floor, White Wood Apartment, Near
                      Puneri Biryani House, Mumbai-Pune Highway, Opp CNG Pump,
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color ">+91-9356247142</p>
                  </div>
                </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color ">
                      accounts@finactaxprobharam.com
                    </p>
                  </div>
                </div>
              </div>
